...
class TopicController extends BaseController
{
    ...
    public function actionUpload()
    {
        ...
        if (Yii::$app->request->isPost) {
            ...
            if ($model->upload(Yii::$app->request->get('id'),'../../frontend/web/assets/topic/','topicUpload')) {
                // 文件上传成功
                header('location:http://admin.zmzfang.com/?r=topic/update&id='.Yii::$app->request->get('id'));
                exit;
            }
        }
