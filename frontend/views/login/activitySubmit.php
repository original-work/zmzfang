...
<body>
	...
	<div class="content">
		...
		<div class="col-md-7">
			...
			<a class="btn btn-default" href="<?=$_SERVER['REQUEST_URI']?>&org=0" role="button">个人</a><a class="btn btn-default" href="<?=$_SERVER['REQUEST_URI']?>&org=1" role="button">企业社团组织</a>
			<?php endif; ?>

			<div id="zbfTable">
			<?php if (!$org && $_GET['org']==1):  ?>
				<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">新增主办方</button>
			<?php elseif ($org && $_GET['org']==1) :?>
			...
			<form  id="activityForm" style="<?=!isset($_GET['org'])?'display:none':''?>" action="" method="POST">
				<input type="hidden" value="<?=$_GET['org']?>" name="organizationauth" />
				<input type="hidden" value="<?=$userInfo['id']?>" name="publishuserid" />
				<input type="hidden" value="<?=$userInfo['nickname']?>" name="publishusername" />
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="activitysubject" placeholder="请输入活动主题" name="activitysubject" required>
				</div>
				<div class="form-group">
					<label>活动背景图</label>
					<div class="pick-button">
						<label for="activitypic"></label>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="startime" name="begintime" readonly="readonly">
				...
				<div class="form-group">
					...
					<select id="region" class="form-control"><option>-- 请先选择城市 --</option></select>
				</div>
				<div class="form-group">
					<label for="location">活动地点</label>
					<input type="text" class="form-control" id="location" placeholder="请输入活动地点" name="location" required>
				</div>
				<div class="form-group">
					<label for="activitysubject">人数限制</label>
					<input type="number" class="form-control" id="personcount" placeholder="请输入人数限制,填0则代表不限人数" name="personcount" required>
				</div>
				<div class="form-group">
					<label for="fee">报名费用</label>
					<input type="text" class="form-control" id="fee" placeholder="请输入报名费用,填0则代表免费" name="fee" required>
				</div>
				<label>活动详情</label>
