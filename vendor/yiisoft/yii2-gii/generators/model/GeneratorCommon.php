 ...
 * @since 2.0
 */
class GeneratorCommon extends \yii\gii\Generator
{
    public $db = 'db';
    ...
    public function generate()
    {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            $servicePath = Yii::getAlias('@' . str_replace('\\', '/', $this->ns)) . '/../services/' . $serviceClassName . '.php';
            if(file_exists($servicePath) == false){ // generated only once
                ...
                $files[] = new CodeFile(
                    Yii::getAlias('@' . str_replace('\\', '/', $this->ns)) . '/../services/' . $serviceClassName . '.php',
